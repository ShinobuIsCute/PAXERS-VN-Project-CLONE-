label chapter02:
    ...
    "TV" "Another person has gone missing from Asteroth Academy while a missing person in a related case has just been found heavily injured and was recently taken to hospital via helicopter {i}from WHERE?!{/i} for urgent medical care"
...
label ch241:
    ...
    "(random girl)" "Hey, you!"
    "(random girl)" "Yes, you- the one looking behind to find someone else."
...
label ch241_a:
    ...
    Note: can do a pan-in too. Stop the music here to build suspense.
    ...
    "{i}Someone was recently here. I see a trail of muddy footsteps vanishing into the hallway.{/i}"
    ...
    if d20 < 10:
        ...
        label cha241Loop:
            if cha241Count == 5:
                ...
                $ cha241Count += 1
                "After trying %(cha241Count+5)s doors, you still feel like this is not going anywhere."
                menu:
                    "Check the next door":
                        jump cha241Loop
                    "Make a plan":
...
label cha242_b:
    ...
    "Winds swish in and out as papers ruffle on top of a table weighted on by a big stone."    
