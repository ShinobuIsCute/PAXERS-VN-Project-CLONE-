...
define 50s = Character("Nyofu", color = "ffffff")
style ita:
	italic True
...
label lsp_1:
	...
	"The iconic white and gold has always been part of {school_name}'s prestigious image, but you've always found it {opinion1}"
